...
import com.shirin.jpaspecdynamicsearchengine.book.application.search.PageResponse;
...
class BookSearchRestControllerTest {
    ...
    void returnsPageResponseOnValidSearchRequest() throws Exception {
        ...
        PageResponse<BookSearchResult> response = new PageResponse<>(
                        List.of(
    ...
    void returnsBadRequestOnValidatorReturnsViolations() throws Exception {
        ...
        Set<ConstraintViolation<BookSearchCriteria>> violations = Set.of(
        ...
        verify(bookSearchUseCase, never()).searchForApi(any(BookSearchCriteria.class), any(Pageable.class));
    }
    ...
    void returnsBadRequestOnSearchRangesAreInvalid() throws Exception {
        ...
        mockMvc.perform(post("/api/books/search")
                ...
                .andExpect(jsonPath("$.fieldErrors[*].field",
                        containsInAnyOrder("minPrice","publishYearFrom")));
    ...
    void appliesPagingAndSortingParameters() throws Exception {
        ...
        mockMvc.perform( post("/api/books/search?page=1&size=5&sort=price,desc")
                                .contentType(MediaType.APPLICATION_JSON)
